...
def getMinMaxTemp(dailyValues, hourlyWeather, currentIndex):  
  ...
  with right:
    st.markdown("<h1 style='font-size:20px; text-align:center; color: black;'>Max Windchill</h1>", unsafe_allow_html=True)
    html_str = f"""
...
#Get average temperature and windchill for rest of the day
    ...
    with right:
      st.markdown("<h1 style='font-size:20px; text-align:center; color: black;'>Average Windchill</h1>", unsafe_allow_html=True)
      html_str = f"""
